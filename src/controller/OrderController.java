...
public class OrderController {
    ...
    @FXML
    private TextField txt_cashierName;
    ...
    void btnReportOnAction(ActionEvent event) {
        try {
            //load jrxml as a inputStream
            InputStream is = this.getClass().getResourceAsStream("../view/Order_Report.jrxml");

            //Compile the jrml file
            JasperReport jasperReport = JasperCompileManager.compileReport(is);

            HashMap<String, Object> hashMap = new HashMap<>();
            hashMap.put("cashier_name", txt_cashierName.getText().trim());

            //fill the compiled report
            JasperPrint jp = JasperFillManager.fillReport(jasperReport, (Map<String, Object>)hashMap, DbConnection.getInstance().getConnection());
