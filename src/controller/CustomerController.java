...
public class CustomerController {
    ...
    void btnReportOnAction(ActionEvent event) {
        try {
            ...
            InputStream is = this.getClass().getResourceAsStream("../view/Customer_Report.jrxml");

            //Compile the jrml file
            JasperReport jasperReport = JasperCompileManager.compileReport(is);

            //fill the compiled report
            JasperPrint jp = JasperFillManager.fillReport(jasperReport, null, DbConnection.getInstance().getConnection());
